...
- **npm 版本**：工具面语义 semver——新工具/参数/能力 → minor，修复、文档 → patch，破坏工具契约 → major；0.x 期间 minor 可含破坏性变更，稳定时升 1.0.0。release commit 集中版本号，build+list-tools 全绿后 publish 到 npmjs（[checklist](.agents/notes/implemented/process/2026-09-19-npm-release-versioning.md)）。
